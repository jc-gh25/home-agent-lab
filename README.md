...
- [Sandbox pipe source](llm_autonomous_chat.py)
- [Research pipe source](llm_autonomous_chat_v2_research_fork.py)
...
files locally in the future, use `git mv` and update this README and links in
published posts.
...
├── pipes/
│   ├── v1.9-sandbox-fork/README.md
│   └── v2.0-research-fork/README.md
└── runs/
    ├── README.md
    └── [raw .txt logs; v2.0 also creates .jsonl sidecars]
```
...
methods, and raw logs are published so that readers can distinguish what a run
shows from what I infer from it.
